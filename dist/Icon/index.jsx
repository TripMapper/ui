...
export default function Icon({ of, xs = false, s = false, m, l = false, xl = false, xxl = false, }) {
    ...
    const className = cx(css.icon, xs && css.xs, s && css.s, m && css.m, l && css.l, xl && css.xl, xxl && css.xxl);
